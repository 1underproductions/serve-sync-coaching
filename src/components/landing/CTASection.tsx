  ...
  return (
    <section className="py-20 tennis-gradient text-white">
      <div className="container text-center">
        ...
        <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Join thousands of tennis coaches who use Tennexis to streamline their operations and grow their business.</p>
