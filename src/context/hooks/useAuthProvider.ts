...
export const useAuthProvider = () => {
  ...
  const signUp = async (email: string, password: string, metadata: any) => {
    try {
      ...
      console.log('Starting signup process with custom email function...');
      
      // Create the user account first without sending the default email
      ...
      // Now send the custom branded email
      try {
        console.log('Sending custom signup email...');
        await sendCustomEmail('signup', email, {
          fullName: metadata.fullName,
          redirect_to: `${window.location.origin}/auth/callback`,
          token: data.user?.email_confirmed_at ? undefined : 'placeholder' // Will be generated by the function
        });
